...
public class CommonMethods {
	...
	public static void selectRadioButtonText(List<WebElement> element, String text) {
	...
	public static void selectRadioButtonValue(List<WebElement> element, String value) {
		...
		for (WebElement el : element) {
			...
			if (val.equals(value)) {
				...
				System.out.println("Option with text " + val + " is not available");
			}
		}
	}

	public static void selectCheckBox(List<WebElement> element, String text) {
	...
	public static void selectValueFromDD1(WebElement element, String text) {
		Select select = new Select(element);
		List<WebElement> options = select.getOptions();
		boolean isSelected = false;
		...
		for (WebElement option : options) {
			...
			if (optionText.equals(text)) {
				...
				System.out.println("Option with text " + text + " selected");
	...
	public static void pickDatefromCalendar(List<WebElement> element, String text) {
	...
	public static void verifyInfo(String actual, String expected) {
		if (actual.equals(expected)) {
			System.out.println("Actual text mathces expected");
		} else {
			System.out.println("Actual text doesn't match expected");
		}
	}
	
	public static void verifyDetails(String actual, String expected) {
		if (actual.equals(expected)) {
			System.out.println(actual +" is verified");
		} else {
			System.out.println(actual + " did not pass verification");
		}
	}

	public static void isDisplayed(boolean value, String text) {
		if (value) {
	...
	public static void isSelected(boolean value, String text) {
	...
	public static void scrolDown(int pixels) {
